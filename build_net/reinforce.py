...
class reinforce(lrcn.lrcn):
  ...
  def make_caption_model(self, static_input='fc8'):
    ...
    for t in range(self.T):
      ...
      #self.n.tops[bottom_cont_reshape_t] = L.Reshape(self.n.tops[bottom_cont_t], shape=dict(dim=[1,1,-1])) #needed to do for depricated version of caffe
      ...
      self.n.tops[top_name_hidden2], self.n.tops[top_name_cell2] = self.lstm_unit('lstm2', self.n.tops[top_name_hidden1], 
                                                                   self.n.tops[bottom_cont_t], static=self.n.tops[lstm_static], 
